 ...
 */
 public class AccountDAO {
    ...
    public boolean delete(int id) {
        ...
        try {
            connection = AccountDAO.JDBCUtil.getConnection();
            //2. 构建删除的sql语句
            ...
            AccountDAO.JDBCUtil.close(connection,statement,null);
        }
        return false;
    }
    ...
    public static class JDBCUtil {
        ...
        public static void close(Connection connection, Statement statement, Object o) {
        }
